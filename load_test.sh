...
echo $rank > rank
./mqtt-load-testing -broker tcp://a43d65bcf37b94c42835233b58cb4dc8-bdeaf8b09fa28444.elb.eu-west-3.amazonaws.com:1883 -connect-every-publish -delay-between-publish 20000 -topic 'v1/devices/me/telemetry' -number-of-messages 180 -csv heartbeat/$rank -rampup-duration 20 --reconnect-tries 100 -debug > log &
